  ...
  "content": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "type": "text",
          "title": "4.謝礼",
          "content": "この実験への参加に対する謝礼はAmazon-eGiftです。"
        },
        {
          "required": true,
          "type": "text",
...
this.state.participantID = participantID;
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              "required": true,
              "type": "radio",
              "label": "先ほどの実験で作品を選ぶ際、サムネイルを参考にした。",
              "options": [
                {
                  "label": "非常にあてはまる",
                  "coding": "5"
            ...
            },
            {
              "required": true,
              "type": "radio",
              "label": "先ほどの実験で作品を選ぶ際、タイトルを参考にした。",
              "options": [
                {
                  "label": "非常にあてはまる",
                  "coding": "5"
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              "required": true,
              "type": "radio",
              "label": "先ほどの実験で作品を選ぶ際、ランキングを参考にした。",
              "options": [
                {
                  "label": "非常にあてはまる",
                  "coding": "5"
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              "required": true,
              "type": "radio",
              "label": "先ほどの実験で作品を選ぶ際、SNSバッジ(「Xでトレンド入り」など)を参考にした。",
              "options": [
                {
                  "label": "非常にあてはまる",
                  "coding": "5"
      ...
      "items": [
        {
          "type": "text",
          "title": "本実験・調査の目的",
          "content": "この実験は、以下の3パターンを参加者の皆さんにランダムに振り分けて表示していました。"
        },
        {
          "required": true,
          "type": "text",
          "content": "A：サムネイルとタイトルのみが表示される"
        },
        {
          "required": true,
          "type": "text",
          "content": "B：サムネイルとタイトル、ランキングが表示される"
        },
        {
          "required": true,
          "type": "text",
          "content": "C：サムネイルとタイトル、SNSバッジ(「Xでトレンド入り」など)が表示される"
        },
        {
          "required": true,
          "type": "text",
          "content": "これによって動画配信サービスにおいて、「公式ランキング情報」と「SNSトレンド情報」という異なる2つのナッジが、コンテンツ選定にかかる時間にどう影響するかを検証することを目的としていました。"
        },
        {
          "required": true,
          "type": "radio",
        ...
        },
        {
          "required": true,
          "type": "radio",
          "label": "この実験の目的を理解した上で、回答済みのデータを分析に利用することに同意しますか？",
          "options": [
            {
              "label": "はい",
              "coding": "1"
    ...
    },
    {
      ...
      "items": [
        {
          "type": "text",
          "title": "実験の謝礼として、Amazon e-Giftをお送りしますので、メールアドレスを記入してください。"
        },
        {
          "required": true,
          "type": "input",
